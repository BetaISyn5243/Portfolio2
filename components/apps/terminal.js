...
export class Terminal extends Component {
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">batuhan@betaisyn</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/batuhan")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-batuhan, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-batuhan":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-batuhan");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-batuhan, todoist, trash, settings, sendmsg ]";
                }
                break;
    ...
    render() {
        return (
            <div className="h-full w-full bg-ub-drk-abrgn bg-opacity-25 text-white text-sm font-bold " id="terminal-body">
                {
                    this.state.terminal
                }
            </div>
