...
export default function SideBar(props) {
    ...
    return (
        <>
            <div className={(props.hide ? " -translate-x-full " : "") + " absolute transform duration-300 select-none z-40 left-0 top-1/4  h-auto rounded  w-auto flex flex-col justify-start items-center border-black border-opacity-60 bg-black bg-opacity-0"}>
                {
                    (
...
export function AllApps(props) {
    ...
    return (
        <div
            className={`w-10 h-10 rounded m-1 hover:bg-black hover:bg-opacity-20 flex items-center justify-center`}
        ...
        >
            <div className="relative">
                <img width="28px" height="28px" className="w-7" src="./themes/Yaru/system/view-app-grid-symbolic.svg" alt="Kali view app" />
                <div
                    className={
