    ...
    render() {
        return (
            <div
                ...
                className={(this.props.isClose[this.id] === false && this.props.isFocus[this.id] ? "bg-white bg-opacity-10 " : "") + " w-auto p-2 outline-none relative transition hover:bg-black hover:bg-opacity-20 rounded m-1"}
                id={"sidebar-" + this.props.id}
            >
                <img width="28px" height="28px" className="w-7" src={this.props.icon} alt="Kali App Icon" />
